...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(os.path.join('/Your file path/checkpoints', args.name, 'checkpoint_best{}.pt'.format(args.extra)),
                            map_location='cpu')
    ...
    checkpoint = torch.load(os.path.join('/Your file path/checkpoints', args.name, 'checkpoint_best{}.pt'.format(extra)),
                            map_location='cpu')
